...
- threshold chores only if they are physically real
- no fake carryover story for tasks that were already finished on 2026-04-04
...
- note what actually got finished
- set next week's first task without adding a full chore universe
...
- keep shoe midsoles as a small weekly upkeep task, not as a signal to invent a full shoe-care project
